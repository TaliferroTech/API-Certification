// SAVE: previously loaded GSAP Globals
...
var SplitType = (function (t, e, n) {
  ...
  function s(t) {
    ...
    var e = t.length;
    return 0 === e || ("number" == typeof e && e > 0 && e - 1 in t);
  }
  function l(t) {
    var e = {},
      n = function (t) {
  ...
  function o(t) {
    return "object" != typeof t || null === t
      ? !1
      : 1 === t.nodeType || 3 === t.nodeType || 11 === t.nodeType;
  }
  function r(t) {
    return t
      ? {
  ...
  function c(t, e, n, i) {
    "insertRule" in t
      ? t.insertRule(e + "{" + n + "}", i || 0)
      : "addRule" in t && t.addRule(e, n, i || 0);
  }
  function p(t) {
    var n = t || {},
      s = n.content,
      l = n.data,
      r = e.createElement(n.nodeName || b.nodeName);
    switch (
      ((r.className = ((n["class"] || "") + " " + b.splitClass).trim()),
      n.style && (r.style.cssText = n.style),
      "object" === i(l) &&
  ...
  function h(t) {
    ...
    if ("string" == typeof t) {
      ...
      t =
        ...
        i.indexOf(">") > -1 &&
        "#" === i.charAt(0)
          ? e.getElementById(i.substring(1))
          : e.querySelectorAll(i);
    }
    if (s(t))
      for (var l = t.length, r = 0; l > r; r++)
        if (s(t[r]))
          for (var a = 0, c = t[r].length; c > a; a++)
            o(t[r][a]) && n.push(t[r][a]);
        else o(t[r]) && n.push(t[r]);
    else o(t) && (n = [t]);
    return n;
  }
  function f(t, e) {
    var n,
      ...
      g = [],
      b = [],
      m = t.textContent.replace(/\s+/g, " ").trim(),
      j = v();
    m.split(" ").forEach(function (t, e) {
      c
        ? ((n = v()),
            ...
            b.push(
              n.appendChild(
                (s = p({
                  ...
                  content: t,
                  nodeName: "div",
                  data: {last: r && !a && e === i.length - 1},
                })),
              ),
            );
          }))
        : (n = y(t)),
        (i = a || r ? p({"class": o.wordClass, content: n}) : n),
        j.appendChild(i),
        j.appendChild(C()),
        (a || r) && g.push(i);
    }, this),
      (t.innerHTML = ""),
      t.appendChild(j),
      (l.allWords = a ? l.allWords.concat(g) : []),
      (l.allChars = c ? l.allChars.concat(b) : []),
      (r || h) &&
        (r && ((f = u.call(this, t, g, b)), (g = a ? g : [])),
        h && d.call(this, t, f, g, b));
  }
  function u(t, e, n) {
    var i,
      s = this._SPLIT,
      l = s.settings,
      o = (l.splitLines, l.splitWords),
      r = l.splitChars,
      a = [],
      c = [],
      h = -999,
    ...
    for (
      e.forEach(function (t) {
        (i = t.offsetTop), i !== h && ((c = []), a.push(c), (h = i)), c.push(t);
      }, this),
        a.forEach(function (t, e) {
          var n = p({"class": l.lineClass});
    ...
    return t.appendChild(f), a;
  }
  function d(e, n, i, s) {
    var l,
      o = this._SPLIT,
      a = o.settings,
      c = (a.splitLines, a.splitWords, a.splitChars, e.offsetHeight),
      p = e.offsetWidth,
      h = [].concat(n, i, s),
      f = h.length,
      a = t.getComputedStyle(e);
    for (
      e.style.position = "static" === a.position ? "relative" : a.position,
        e.style.height = c + "px",
    ...
    for (l = 0; f > l; l++) {
      var u = h[l];
      (u.style.top = u.pos.top + "px"),
        (u.style.left = u.pos.left + "px"),
        (u.style.height = u.pos.height + "px"),
        (u.style.width = u.pos.width + "px"),
  ...
  var b = {
    ...
    text: !1,
    get splitLines() {
      return -1 !== this.split.indexOf("lines");
    },
    get splitWords() {
      return -1 !== this.split.indexOf("words");
    },
    get splitChars() {
      return -1 !== this.split.indexOf("chars");
    },
    get isAbsolute() {
      return (
        ("string" == typeof this.position &&
          "absolute" === this.position.toLowerCase()) ||
        this.absolute === !0
      );
    },
  };
  Object.defineProperty(g, "settings", {
    get: function () {
      return b;
    },
    set: function (t) {
  ...
  var y = function (t) {
    ...
    m = {},
    j = m.toString;
  "Boolean Number String Function Array Object Null"
    .split(" ")
    .forEach(function (t) {
  ...
  var L = a();
  return (
    c(L, ".is-splitting", "visibility: hidden; position: absolute;"),
    c(L, ".split-item", "display: inline-block; position: relative;"),
    (g.prototype = {
      split: function (e) {
        var n = this._SPLIT,
          i = (n.settings, n.elements),
          s = [t.scrollX, t.scrollY];
        return (
          (n.allLines.length = n.allWords.length = n.allChars.length = 0),
          (n.settings = e ? l(n.settings, e) : n.settings),
          i.forEach(function (t) {
            t.parentElement.classList.add("is-splitting");
          }),
          i.forEach(function (t, e) {
            f.call(this, t);
          }, this),
          i.forEach(function (t) {
            t.parentElement.classList.remove("is-splitting");
          }),
          t.scrollTo(s[0], s[1]),
          this
        );
      ...
      revert: function () {
        var t = this._SPLIT;
        (t.allLines.length = t.allWords.length = t.allChars.length = 0),
          t.elements.forEach(function (e, n) {
            e.innerHTML = t.originals[n];
          });
      },
      get lines() {
...
// RESTORE: previously loaded GSAP Globals
