!(function (t, e) {
  ...
  function r(t, e) {
    ...
    if ((t !== u && e !== u) || s.contains(a))
      return "BODY" === (c = (h = u).nodeName) ||
        ("HTML" !== c && n(h.firstElementChild) !== h)
        ? n(u)
        : u;
    var d = o(t);
  ...
  function p(t, i) {
    ...
    return (
      (n ? i.contains(h) : i === h && "BODY" !== h.nodeName) &&
        (g = (function (t, e) {
          var i =
  ...
  function f(t, n, o, l) {
    ...
    if ("viewport" === l)
      (h = y),
        ...
        (f = p(h, d)),
        (g = F(d.clientWidth, window.innerWidth || 0)),
        (m = F(d.clientHeight, window.innerHeight || 0)),
        (v = a(d)),
        (_ = a(d, "left")),
        (b = u({
      ...
      var w;
      "scrollParent" === l
        ? "BODY" === (w = s(i(t))).nodeName &&
          (w = window.document.documentElement)
        : (w = "window" === l ? window.document.documentElement : l);
      var C = p(w, y);
      if (
        "HTML" !== w.nodeName ||
        (function t(s) {
        ...
        var x = c(),
          k = x.height,
          D = x.width;
        (b.top += C.top - C.marginTop),
          (b.bottom = k + C.top),
          (b.left += C.left - C.marginLeft),
          (b.right = D + C.left);
      }
    }
  ...
  var L,
    ...
    j = function () {
      return (
        null == L && (L = -1 !== navigator.appVersion.indexOf("MSIE 10")), L
      );
    },
    B = function (t, e) {
      if (!(t instanceof e))
    ...
    Z = (function () {
      function e(i, s) {
        ...
        B(this, e),
          ...
          Object.keys(U({}, e.Defaults.modifiers, o.modifiers)).forEach(
            function (t) {
              n.options.modifiers[t] = U(
                {},
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function (t) {
              return U({name: t}, n.options.modifiers[t]);
            })
            .sort(function (t, e) {
    ...
    (Z.Defaults = {
      ...
      modifiers: {
          ...
          fn: function (t) {
            ...
            if (s) {
              var n = t.offsets,
                ...
                l = a ? "left" : "top",
                h = a ? "width" : "height",
                c = {start: q({}, l, o[l]), end: q({}, l, o[l] + o[h] - r[h])};
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            var s = t.placement.split("-")[0],
              ...
              d = a ? "bottom" : "right",
              p = v(i)[l];
            r[d] - p < o[h] && (t.offsets.popper[h] -= o[h] - (r[d] - p)),
              r[h] + p > o[d] && (t.offsets.popper[h] += r[h] + p - o[d]);
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var a,
              ...
              m = x("transform");
            if (
              ((l = "bottom" == f ? -c.height + p.bottom : p.top),
        ...
        applyStyle: {
          ...
          fn: function (t) {
            return (
              E(t.instance.popper, t.styles),
              (e = t.instance.popper),
              (i = t.attributes),
              Object.keys(i).forEach(function (t) {
                !1 === i[t] ? e.removeAttribute(t) : e.setAttribute(t, i[t]);
              }),
              t.offsets.arrow && E(t.arrowElement, t.offsets.arrow),
              t
            );
            var e, i;
          },
          onLoad: function (t, e, i, s, n) {
            ...
            return (
              e.setAttribute("x-placement", r), E(e, {position: "absolute"}), i
            );
          },
  ...
  (function (t, e) {
    ...
    var r,
        ...
        (g = (function () {
          ...
          return (
            ...
            (e._removeElement = function (t) {
              var e = this;
              r(t).removeClass(f),
                Ci.supportsTransitionEnd() && r(t).hasClass(p)
                  ? r(t)
                      .one(Ci.TRANSITION_END, function (i) {
      ...
      ki =
        ...
        (P = (function () {
          ...
          return (
                ...
                if (s) {
                  ...
                  if (t) {
                    if (
                      ...
                      return;
                    (s.checked = !m(this._element).hasClass(C)),
                      m(s).trigger("change");
                  }
                  s.focus(), (e = !1);
                }
            ...
            (t._jQueryInterface = function (e) {
              return this.each(function () {
                var i = m(this).data(_);
                i || ((i = new t(this)), m(this).data(_, i)),
                  "toggle" === e && i[e]();
              });
            }),
            n(t, null, [
        ...
        m(document)
          .on(A.CLICK_DATA_API, D, function (t) {
            t.preventDefault();
            var e = t.target;
            m(e).hasClass(x) || (e = m(e).closest(S)),
      ...
      Di =
        ...
        (J = (function () {
          function t(t, e) {
            (this._items = null),
              ...
              (this._element = M(t)[0]),
              (this._indicatorsElement = M(this._element).find(
                Z.INDICATORS,
              )[0]),
          ...
          return (
            ...
            (e.pause = function (t) {
              t || (this._isPaused = !0),
                M(this._element).find(Z.NEXT_PREV)[0] &&
                  Ci.supportsTransitionEnd() &&
                  (Ci.triggerTransitionEnd(this._element), this.cycle(!0)),
              ...
              this._config.keyboard &&
                ...
                "hover" === this._config.pause &&
                  ...
                  "ontouchstart" in document.documentElement &&
                    M(this._element).on(Y.TOUCHEND, function () {
                      t.pause(),
            ...
            (e._getItemIndex = function (t) {
              return (
                (this._items = M.makeArray(M(t).parent().find(Z.ITEM))),
            ...
            (e._slide = function (t, e) {
              ...
              if (
                ...
                Ci.supportsTransitionEnd() && M(this._element).hasClass(K)
                  ? (M(l).addClass(s),
                    Ci.reflow(l),
                    M(r).addClass(i),
                    M(l).addClass(i),
                    M(r)
                      .one(Ci.TRANSITION_END, function () {
                        M(l)
                          .removeClass(i + " " + s)
                          .addClass(U),
                          M(r).removeClass(U + " " + s + " " + i),
                          (o._isSliding = !1),
                          setTimeout(function () {
            ...
            (t._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  (i || ((i = new t(this, s)), M(this).data(O, i)),
                  "number" == typeof e)
                )
                  i.to(e);
        ...
        M(document).on(Y.CLICK_DATA_API, Z.DATA_SLIDE, J._dataApiClickHandler),
        ...
        (M.fn[F] = J._jQueryInterface),
        (M.fn[F].Constructor = J),
          ...
          return (
            ...
            (e.show = function () {
              ...
              if (
                ...
                !(
                  e &&
                  (i = tt(e).not(this._selector).data(it)) &&
                  i._isTransitioning
                ))
              ) {
                ...
                if ((tt(this._element).trigger(n), !n.isDefaultPrevented())) {
                  ...
                  var r = function () {
                    tt(s._element).removeClass(ct).addClass(ht).addClass(lt),
                      (s._element.style[o] = ""),
                      s.setTransitioning(!1),
                      tt(s._element).trigger(at.SHOWN);
                  };
                  if (Ci.supportsTransitionEnd()) {
                    var a = "scroll" + (o[0].toUpperCase() + o.slice(1));
                    tt(this._element)
                      .one(Ci.TRANSITION_END, r)
                      .emulateTransitionEnd(600),
                ...
                if ((tt(this._element).trigger(e), !e.isDefaultPrevented())) {
                  ...
                  if (
                    ...
                    for (var s = 0; s < this._triggerArray.length; s++) {
                      ...
                      if (null !== o)
                        tt(o).hasClass(lt) ||
                          tt(n).addClass(ut).attr("aria-expanded", !1);
                    }
                  this.setTransitioning(!0);
                  var r = function () {
            ...
            (e.dispose = function () {
              tt.removeData(this._element, it),
                (this._config = null),
                (this._parent = null),
                (this._element = null),
            ...
            (e._getConfig = function (t) {
              return (
                ((t = o({}, ot, t)).toggle = Boolean(t.toggle)),
                Ci.typeCheckConfig(et, t, rt),
                t
              );
            }),
            ...
            (e._getParent = function () {
              var e = this,
                i = null;
              Ci.isElement(this._config.parent)
                ? ((i = this._config.parent),
                  void 0 !== this._config.parent.jquery &&
                    (i = this._config.parent[0]))
                : (i = tt(this._config.parent)[0]);
              var s =
            ...
            (e._addAriaAndCollapsedClass = function (t, e) {
              if (t) {
                ...
                e.length > 0 &&
                  tt(e).toggleClass(ut, !i).attr("aria-expanded", i);
              }
            }),
      ...
      Ei =
        ...
        (At = "dropdown-menu-left"),
        (Pt = "position-static"),
        (Mt = '[data-toggle="dropdown"]'),
        (Ft = ".dropdown form"),
        (Ot = ".dropdown-menu"),
        (zt = ".navbar-nav"),
        (Nt = ".dropdown-menu .dropdown-item:not(.disabled)"),
        (Ht = "top-start"),
        ($t = "top-end"),
        (Lt = "bottom-start"),
        (Wt = "bottom-end"),
        (Rt = "right-start"),
        (jt = "left-start"),
        (Bt = {offset: 0, flip: !0, boundary: "scrollParent"}),
        (Yt = {
          ...
          return (
                ...
                if ((t._clearMenus(), !s)) {
                  ...
                  if ((mt(e).trigger(o), !o.isDefaultPrevented())) {
                    if (!this._inNavbar) {
                      ...
                      var r = this._element;
                      mt(e).hasClass(It) &&
                        (mt(this._menu).hasClass(At) ||
                          mt(this._menu).hasClass(St)) &&
                        (r = e),
                    ...
                    "ontouchstart" in document.documentElement &&
                      0 === mt(e).closest(zt).length &&
                      mt("body").children().on("mouseover", null, mt.noop),
                      this._element.focus(),
                      this._element.setAttribute("aria-expanded", !0),
                      mt(this._menu).toggleClass(Dt),
                      mt(e).toggleClass(Dt).trigger(mt.Event(xt.SHOWN, n));
                  }
                }
              }
            }),
            ...
            (e._getConfig = function (t) {
              return (
                ...
                Ci.typeCheckConfig(vt, t, this.constructor.DefaultType),
                t
              );
            }),
            ...
            (e._getPlacement = function () {
              ...
              return (
                t.hasClass(It)
                  ? ((e = Ht), mt(this._menu).hasClass(St) && (e = $t))
                  : t.hasClass(Et)
                    ? (e = Rt)
                    : t.hasClass(Tt)
                      ? (e = jt)
                      : mt(this._menu).hasClass(St) && (e = Wt),
                e
              );
            }),
                  ...
                  ? !(
                      ...
                      (27 !== e.which &&
                        ((40 !== e.which && 38 !== e.which) ||
                          mt(e.target).closest(Ot).length))
                    )
                  : Ct.test(e.which)) &&
                (e.preventDefault(),
                e.stopPropagation(),
                !this.disabled && !mt(this).hasClass(kt))
              ) {
        ...
        mt(document)
          .on(xt.KEYDOWN_DATA_API, Mt, qt._dataApiKeydownHandler)
          .on(xt.KEYDOWN_DATA_API, Ot, qt._dataApiKeydownHandler)
          .on(xt.CLICK_DATA_API + " " + xt.KEYUP_DATA_API, qt._clearMenus)
          .on(xt.CLICK_DATA_API, Mt, function (t) {
            t.preventDefault(),
              t.stopPropagation(),
        ...
        (mt.fn[vt] = qt._jQueryInterface),
        (mt.fn[vt].Constructor = qt),
        (mt.fn[vt].noConflict = function () {
      ...
      Ti =
        ...
        (re = (function () {
          function t(t, e) {
            (this._config = this._getConfig(e)),
              (this._element = t),
              (this._dialog = Ut(t).find(oe.DIALOG)[0]),
              (this._backdrop = null),
              (this._isShown = !1),
          ...
          return (
            ...
            (e.show = function (t) {
              ...
              if (!this._isTransitioning && !this._isShown) {
                Ci.supportsTransitionEnd() &&
                  Ut(this._element).hasClass(se) &&
                  (this._isTransitioning = !0);
                var i = Ut.Event(Jt.SHOW, {relatedTarget: t});
                Ut(this._element).trigger(i),
                  this._isShown ||
              ...
              if (
                ...
                if (
                  ...
                  s && (this._isTransitioning = !0),
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    Ut(document).off(Jt.FOCUSIN),
                    Ut(this._element).removeClass(ne),
                    Ut(this._element).off(Jt.CLICK_DISMISS),
                    Ut(this._dialog).off(Jt.MOUSEDOWN_DISMISS),
                    s
                      ? Ut(this._element)
                          .one(Ci.TRANSITION_END, function (t) {
            ...
            (e.dispose = function () {
              Ut.removeData(this._element, Qt),
                Ut(window, document, this._element, this._backdrop).off(Vt),
                (this._config = null),
                (this._element = null),
                (this._dialog = null),
                (this._backdrop = null),
            ...
            (e._showElement = function (t) {
              var e = this,
                i =
                  Ci.supportsTransitionEnd() && Ut(this._element).hasClass(se);
              (this._element.parentNode &&
                ...
                i && Ci.reflow(this._element),
                Ut(this._element).addClass(ne),
                this._config.focus && this._enforceFocus();
              var s = Ut.Event(Jt.SHOWN, {relatedTarget: t}),
                n = function () {
                  e._config.focus && e._element.focus(),
                    (e._isTransitioning = !1),
                    Ut(e._element).trigger(s);
                };
              i
                ? Ut(this._dialog)
                    .one(Ci.TRANSITION_END, n)
                    .emulateTransitionEnd(300)
                : n();
            }),
            (e._enforceFocus = function () {
              ...
              Ut(document)
                ...
                .on(Jt.FOCUSIN, function (e) {
                  document !== e.target &&
                    t._element !== e.target &&
                    0 === Ut(t._element).has(e.target).length &&
                    t._element.focus();
                });
            }),
            (e._setEscapeEvent = function () {
              ...
              this._isShown && this._config.keyboard
                ? Ut(this._element).on(Jt.KEYDOWN_DISMISS, function (e) {
            ...
            (e._setResizeEvent = function () {
              var t = this;
              this._isShown
                ? Ut(window).on(Jt.RESIZE, function (e) {
            ...
            (e._hideModal = function () {
              ...
              (this._element.style.display = "none"),
                ...
                (this._isTransitioning = !1),
                this._showBackdrop(function () {
                  Ut(document.body).removeClass(ie),
                    t._resetAdjustments(),
                    t._resetScrollbar(),
                    Ut(t._element).trigger(Jt.HIDDEN);
                });
            }),
            (e._removeBackdrop = function () {
              this._backdrop &&
                (Ut(this._backdrop).remove(), (this._backdrop = null));
            }),
            (e._showBackdrop = function (t) {
              ...
              if (this._isShown && this._config.backdrop) {
                ...
                if (
                  ...
                  (this._backdrop.className = ee),
                  i && Ut(this._backdrop).addClass(i),
                  Ut(this._backdrop).appendTo(document.body),
                  Ut(this._element).on(Jt.CLICK_DISMISS, function (t) {
                  ...
                  s && Ci.reflow(this._backdrop),
                  Ut(this._backdrop).addClass(ne),
                  !t)
                )
                  return;
                if (!s) return void t();
                Ut(this._backdrop)
                  .one(Ci.TRANSITION_END, t)
                  .emulateTransitionEnd(150);
            ...
            (e._resetScrollbar = function () {
              Ut(oe.FIXED_CONTENT).each(function (t, e) {
                ...
                void 0 !== i &&
                  Ut(e).css("padding-right", i).removeData("padding-right");
              }),
                Ut(oe.STICKY_CONTENT + ", " + oe.NAVBAR_TOGGLER).each(
                  function (t, e) {
                    var i = Ut(e).data("margin-right");
                    void 0 !== i &&
                      Ut(e).css("margin-right", i).removeData("margin-right");
                  },
                );
              var t = Ut("body").data("padding-right");
              void 0 !== t &&
                Ut("body").css("padding-right", t).removeData("padding-right");
            }),
            ...
            (t._jQueryInterface = function (e, i) {
              return this.each(function () {
                ...
                if (
                  (s || ((s = new t(this, n)), Ut(this).data(Qt, s)),
                  "string" == typeof e)
                ) {
                  if (void 0 === s[e])
                    throw new TypeError('No method named "' + e + '"');
        ...
        Ut(document).on(Jt.CLICK_DATA_API, oe.DATA_TOGGLE, function (t) {
          ...
          var n = Ut(e).data(Qt)
            ? "toggle"
            : o({}, Ut(e).data(), Ut(this).data());
          ("A" !== this.tagName && "AREA" !== this.tagName) ||
            t.preventDefault();
          var r = Ut(e).one(Jt.SHOW, function (t) {
            t.isDefaultPrevented() ||
              r.one(Jt.HIDDEN, function () {
                Ut(i).is(":visible") && i.focus();
              });
          });
          re._jQueryInterface.call(Ut(e), n, this);
        }),
        (Ut.fn[Kt] = re._jQueryInterface),
        (Ut.fn[Kt].Constructor = re),
        (Ut.fn[Kt].noConflict = function () {
      ...
      Si =
          ...
          return (
              ...
              if (this._isEnabled)
                if (t) {
                  ...
                  i ||
                    ...
                    ae(t.currentTarget).data(e, i)),
                    (i._activeTrigger.click = !i._activeTrigger.click),
                    i._isWithActiveTrigger()
                      ? i._enter(null, i)
                      : i._leave(null, i);
                } else {
                  if (ae(this.getTipElement()).hasClass(we))
            ...
            (e.dispose = function () {
              clearTimeout(this._timeout),
                ...
                ae(this.element).closest(".modal").off("hide.bs.modal"),
            ...
            (e.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                o.setAttribute("id", r),
                  ...
                  this.setContent(),
                  this.config.animation && ae(o).addClass(ye);
                var a =
                ...
                ae(o).data(this.constructor.DATA_KEY, this),
                  ...
                  ae(o).addClass(we),
                  "ontouchstart" in document.documentElement &&
                    ae("body").children().on("mouseover", null, ae.noop);
                var c = function () {
                  e.config.animation && e._fixTransition();
                  var t = e._hoverState;
                  (e._hoverState = null),
                    ae(e.element).trigger(e.constructor.Event.SHOWN),
                    t === _e && e._leave(null, e);
                };
                Ci.supportsTransitionEnd() && ae(this.tip).hasClass(ye)
                  ? ae(this.tip)
                      .one(Ci.TRANSITION_END, c)
            ...
            (e.hide = function (t) {
              ...
              ae(this.element).trigger(s),
                s.isDefaultPrevented() ||
                  (ae(i).removeClass(we),
                  "ontouchstart" in document.documentElement &&
                    ae("body").children().off("mouseover", null, ae.noop),
                  (this._activeTrigger[Ie] = !1),
                  (this._activeTrigger[De] = !1),
                  (this._activeTrigger[ke] = !1),
                  Ci.supportsTransitionEnd() && ae(this.tip).hasClass(ye)
                    ? ae(i).one(Ci.TRANSITION_END, n).emulateTransitionEnd(150)
                    : n(),
                  (this._hoverState = ""));
            }),
            (e.update = function () {
            ...
            (e.setElementContent = function (t, e) {
              ...
              "object" == typeof e && (e.nodeType || e.jquery)
                ? i
                  ? ae(e).parent().is(t) || t.empty().append(e)
                  : t.text(ae(e).text())
                : t[i ? "html" : "text"](e);
            }),
            (e.getTitle = function () {
            ...
            (e._enter = function (t, e) {
              ...
              (e = e || ae(t.currentTarget).data(i)) ||
                ((e = new this.constructor(
                  t.currentTarget,
                  this._getDelegateConfig(),
                )),
                ae(t.currentTarget).data(i, e)),
                t && (e._activeTrigger["focusin" === t.type ? De : ke] = !0),
                ae(e.getTipElement()).hasClass(we) || e._hoverState === ve
                  ? (e._hoverState = ve)
            ...
            (e._leave = function (t, e) {
              ...
              (e = e || ae(t.currentTarget).data(i)) ||
                ...
                ae(t.currentTarget).data(i, e)),
                t && (e._activeTrigger["focusout" === t.type ? De : ke] = !1),
            ...
            (e._getConfig = function (t) {
              return (
                ...
                Ci.typeCheckConfig(le, t, this.constructor.DefaultType),
                t
              );
            }),
            ...
            (t._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (i || ((i = new t(this, s)), ae(this).data(he, i)),
                  "string" == typeof e)
                ) {
                  if (void 0 === i[e])
                    throw new TypeError('No method named "' + e + '"');
        ...
        (ae.fn[le] = Te._jQueryInterface),
        (ae.fn[le].Constructor = Te),
      ...
      Ai =
        ...
        (He = o({}, Si.DefaultType, {content: "(string|element|function)"})),
        ($e = "fade"),
        (Le = "show"),
        (We = ".popover-header"),
        (Re = ".popover-body"),
          ...
          return (
            ...
            (o.setContent = function () {
              ...
              "function" == typeof e && (e = e.call(this.element)),
                this.setElementContent(t.find(Re), e),
                t.removeClass($e + " " + Le);
            }),
            ...
            (s._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  ...
                  (e || ((e = new s(this, i)), Se(this).data(Pe, e)),
                  "string" == typeof t)
                ) {
                  if (void 0 === e[t])
        ...
        (Se.fn[Ae] = Be._jQueryInterface),
        (Se.fn[Ae].Constructor = Be),
      ...
      Pi =
        ...
        (Ke = "." + (Ue = "bs.scrollspy")),
        (Qe = (Ye = e).fn[qe]),
        (Ve = {offset: 10, method: "auto", target: ""}),
        ...
        (si = (function () {
          function t(t, e) {
            ...
            (this._element = t),
              ...
              Ye(this._scrollElement).on(Ge.SCROLL, function (t) {
                return i._process(t);
              }),
              this.refresh(),
              this._process();
          ...
          return (
            (e.refresh = function () {
              var t = this,
                e =
                  this._scrollElement === this._scrollElement.window ? ei : ii,
                i = "auto" === this._config.method ? e : this._config.method,
                s = i === ii ? this._getScrollTop() : 0;
              (this._offsets = []),
                (this._targets = []),
                (this._scrollHeight = this._getScrollHeight()),
                Ye.makeArray(Ye(this._selector))
                  .map(function (t) {
                    var e,
                      n = Ci.getSelectorFromElement(t);
                    if ((n && (e = Ye(n)[0]), e)) {
            ...
            (e.dispose = function () {
              Ye.removeData(this._element, Ue),
                Ye(this._scrollElement).off(Ke),
                (this._element = null),
            ...
            (e._getConfig = function (t) {
              if ("string" != typeof (t = o({}, Ve, t)).target) {
                ...
                e || ((e = Ci.getUID(qe)), Ye(t.target).attr("id", e)),
                  (t.target = "#" + e);
              }
            ...
            (e._activate = function (t) {
              ...
              var i = Ye(e.join(","));
              i.hasClass(Ze)
                ? (i.closest(ti.DROPDOWN).find(ti.DROPDOWN_TOGGLE).addClass(Je),
                  i.addClass(Je))
                : (i.addClass(Je),
                  i
                  ...
                  i
                    ...
                    .addClass(Je)),
                Ye(this._scrollElement).trigger(Ge.ACTIVATE, {
                  relatedTarget: t,
                });
            }),
            (e._clear = function () {
        ...
        (Ye.fn[qe] = si._jQueryInterface),
        (Ye.fn[qe].Constructor = si),
        (Ye.fn[qe].noConflict = function () {
      ...
      Mi =
        ...
        (wi = (function () {
          ...
          return (
            (e.show = function () {
              ...
              if (
                !(
                  ...
                  ni(this._element).hasClass(ui)
                )
              ) {
                var e,
                  i,
                  s = ni(this._element).closest(gi)[0],
                  n = Ci.getSelectorFromElement(this._element);
                if (s) {
                  var o = "UL" === s.nodeName ? vi : mi;
                  i = (i = ni.makeArray(ni(s).find(o)))[i.length - 1];
                }
                var r = ni.Event(li.HIDE, {relatedTarget: this._element}),
                  a = ni.Event(li.SHOW, {relatedTarget: i});
                if (
                  (i && ni(i).trigger(r),
                  ...
                  var l = function () {
                    var e = ni.Event(li.HIDDEN, {relatedTarget: t._element}),
                      s = ni.Event(li.SHOWN, {relatedTarget: i});
            ...
            (e._activate = function (t, e, i) {
              var s = this,
                n = (
                  "UL" === e.nodeName ? ni(e).find(vi) : ni(e).children(mi)
                )[0],
              ...
              n && o
                ? ni(n).one(Ci.TRANSITION_END, r).emulateTransitionEnd(150)
                : r();
            }),
            (e._transitionComplete = function (t, e, i) {
              ...
              if (
                ...
                Ci.reflow(t),
                ni(t).addClass(pi),
                t.parentNode && ni(t.parentNode).hasClass(hi))
              ) {
                var n = ni(t).closest(fi)[0];
                n && ni(n).find(bi).addClass(ci),
        ...
        (ni.fn.tab = wi._jQueryInterface),
        (ni.fn.tab.Constructor = wi),
  ...
  (function (t) {
    ...
    (g.prototype = {
      ...
      open: function (i) {
        ...
        if (!e.isOpen) {
          ...
          return (
            ...
            setTimeout(function () {
              e.content
                ? (e._addClassToMFP(d), e._setFocus())
                : e.bgOverlay.addClass(d),
      ...
      updateItemHTML: function () {
        ...
        var s = i.type;
        if (
          (y("BeforeChange", [e.currItem ? e.currItem.type : "", s]),
          (e.currItem = i),
          !e.currTemplate[s])
        ) {
        ...
        (e.content = t),
          t
            ? e.st.showCloseBtn &&
              e.st.closeBtnInside &&
              !0 === e.currTemplate[i]
              ? e.content.find(".mfp-close").length || e.content.append(w())
              : (e.content = t)
            : (e.content = ""),
          y("BeforeAppend"),
      ...
      (t.fn.magnificPopup = function (i) {
        ...
        if ("string" == typeof i)
          if ("open" === i) {
            var n,
              o = m ? s.data("magnificPopup") : s[0].magnificPopup,
          ...
          (i = t.extend(!0, {}, i)),
            m ? s.data("magnificPopup", i) : (s[0].magnificPopup = i),
            e.addGroup(s, i);
        return s;
      });
    var x,
        ...
        getInline: function (i, s) {
          if ((E(), i.src)) {
            ...
            if (o.length) {
              ...
              r &&
                r.tagName &&
                (k || ((x = n.hiddenClass), (k = b(x)), (x = "mfp-" + x)),
                (D = o.after(k).detach().removeClass(x))),
    ...
    t.magnificPopup.registerModule(R, {
                ...
                v
                  .on("touchmove" + W, function (t) {
                    (a = t.originalEvent ? t.originalEvent.touches : t.touches),
                      (l = a.length),
                      (a = a[0]),
                      (Math.abs(a.clientX - n) > 10 ||
                        Math.abs(a.clientY - o) > 10) &&
                        ((r = !0), L());
                  })
      ...
      (t.fn.destroyMfpFastClick = function () {
        t(this).off("touchstart" + W + " click" + W),
          $ && v.off("touchmove" + W + " touchend" + W);
      }),
      C();
  }),
    ...
    function i(e, i) {
      ...
      if ("area" === n) {
        var o,
          ...
          a = r.name;
        return (
          !(!e.href || !a || "map" !== r.nodeName.toLowerCase()) &&
          !!(o = t("img[usemap=#" + a + "]")[0]) &&
          s(o)
        );
      }
      ...
      (t.widget.bridge = function (e, i) {
        t.fn[e] = function (s) {
          var n = "string" == typeof s,
            ...
            r = this;
          return (
            (s = !n && o.length ? t.extend.apply(null, [!0, s].concat(o)) : s),
            n && "_" === s.charAt(0)
              ? r
              : (n
                  ? this.each(function () {
      ...
      (t.Widget.prototype = {
        ...
        _trigger: function (e, i, s) {
          ...
          return (
            ...
            !(
              (t.isFunction(r) && !1 === r.call(this.element[0], i, s)) ||
              i.isDefaultPrevented()
            )
          );
        },
        ...
        if (this.originalPosition) {
          ...
          if (this.containment) {
            ...
            e.pageX - this.offset.click.left < a[0] &&
              (o = a[0] + this.offset.click.left),
              e.pageY - this.offset.click.top < a[1] &&
                (r = a[1] + this.offset.click.top),
              e.pageX - this.offset.click.left > a[2] &&
                (o = a[2] + this.offset.click.left),
              e.pageY - this.offset.click.top > a[3] &&
                (r = a[3] + this.offset.click.top);
          }
          if (i.grid) {
            var h = i.grid[1]
              ? this.originalPageY +
            ...
            r =
              a &&
              (h - this.offset.click.top < a[1] ||
                h - this.offset.click.top > a[3])
                ? h - this.offset.click.top < a[1]
                  ? h + i.grid[1]
                  : h - i.grid[1]
                : h;
            ...
            o =
              a &&
              (c - this.offset.click.left < a[0] ||
                c - this.offset.click.left > a[2])
                ? c - this.offset.click.left < a[0]
                  ? c + i.grid[0]
                  : c - i.grid[0]
                : c;
          ...
          t: for (var r = 0; r < s.length; r++)
            if (
              ...
              (s[r].visible = "none" != s[r].element.css("display")),
                s[r].visible &&
                  ("mousedown" == n && s[r]._activate.call(s[r], i),
                ...
                if (
                  ...
                  if (n) {
                    ...
                    if (this.options.greedy) {
                      ...
                      r.length &&
                        ((o = t.data(r[0], "droppable")).greedyChild =
                          "isover" == n ? 1 : 0);
                    }
                    o &&
                      "isover" == n &&
  ...
  (function (t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _mouseStart: function (e) {
        ...
        s.containment &&
          ((r += t(s.containment).scrollLeft() || 0),
      ...
      _mouseStop: function (e) {
        ...
        if (this._helper) {
          var n = this._proportionallyResizeElements,
            ...
            l = {width: s.helper.width() - a, height: s.helper.height() - r},
            h =
      ...
      _respectSize: function (t, e) {
        ...
        a && u && (t.left = h - i.minWidth),
          o && u && (t.left = h - i.maxWidth),
          l && d && (t.top = c - i.minHeight),
          r && d && (t.top = c - i.maxHeight);
      ...
      t.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (e, i) {
          ...
          h[0] != document && /static/.test(h.css("position")) && (l = o),
            r.left < (s._helper ? o.left : 0) &&
              ((s.size.width =
                s.size.width +
                (s._helper
                  ? s.position.left - o.left
                  : s.position.left - l.left)),
              a && (s.size.height = s.size.width / s.aspectRatio),
              (s.position.left = n.helper ? o.left : 0)),
            r.top < (s._helper ? o.top : 0) &&
              ((s.size.height =
                s.size.height +
                (s._helper ? s.position.top - o.top : s.position.top)),
          ...
          var c = Math.abs(
            ...
            u = Math.abs(
              (s._helper ? s.offset.top - l.top : s.offset.top - o.top) +
                s.sizeDiff.height,
            ),
        ...
        stop: function (e, i) {
          ...
          s._helper &&
            ...
            t(this).css({left: h.left - r.left - o.left, width: c, height: u}),
            s._helper &&
              !n.animate &&
      ...
      t.ui.plugin.add("resizable", "grid", {
        resize: function (e, i) {
          ...
          var h =
              Math.round((o.width - r.width) / (n.grid[0] || 1)) *
              (n.grid[0] || 1),
            c =
              Math.round((o.height - r.height) / (n.grid[1] || 1)) *
              (n.grid[1] || 1);
          /^(se|s|e)$/.test(l)
            ? ((s.size.width = r.width + h), (s.size.height = r.height + c))
            : /^(ne)$/.test(l)
              ? ((s.size.width = r.width + h),
    ...
    t.widget("ui.selectable", t.ui.mouse, {
      ...
      _mouseDrag: function (e) {
        ...
        if (((this.dragged = !0), !this.options.disabled)) {
          ...
          return (
            this.helper.css({left: n, top: o, width: r - n, height: a - o}),
            this.selectees.each(function () {
              ...
              if (l && l.element != i.element[0]) {
                ...
                "touch" == s.tolerance
                  ...
                  : "fit" == s.tolerance &&
                    (h =
                      l.left > n && l.right < r && l.top > o && l.bottom < a),
                  h
                    ? (l.selected &&
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _mouseCapture: function (e, i) {
        ...
        t(e.target)
          .parents()
          .each(function () {
            if (t.data(this, s.widgetName + "-item") == o)
              return (n = t(this)), !1;
          });
        if (
          (t.data(e.target, s.widgetName + "-item") == o && (n = t(e.target)),
          !n)
        )
          return !1;
      ...
      _refreshItems: function (e) {
        ...
        for (o = s.length - 1; o >= 0; o--)
          for (
            var h = s[o][1], c = s[o][0], u = ((a = 0), c.length);
            a < u;
            a++
          ) {
            var d = t(c[a]);
    ...
    (function (t, e) {
        ...
        t.each(
          ...
          function (e, s) {
            t.fx.step[s] = function (e) {
              e.colorInit ||
                ((e.start = (function (e, s) {
                  var n;
                  do {
                    if (
                      ("" != (n = (t.curCSS || t.css)(e, s)) &&
                        "transparent" != n) ||
                      t.nodeName(e, "body")
                    )
                      break;
      ...
      (t.effects.animateClass = function (e, i, o, r) {
        ...
        t.fn.extend({
          ...
          toggleClass: function (i, s, n, o, r) {
            return "boolean" == typeof s || s === e
              ...
              : t.effects.animateClass.apply(this, [{toggle: i}, s, n, o]);
          },
        ...
        t.fn.extend({
          ...
          toggle: function (e) {
            if (r(e) || "boolean" == typeof e || t.isFunction(e))
        ...
        t.extend(t.easing, {
          ...
          easeInBack: function (t, i, s, n, o, r) {
            return (
              r == e && (r = 1.70158), n * (i /= o) * i * ((r + 1) * i - r) + s
            );
          },
          easeOutBack: function (t, i, s, n, o, r) {
            return (
              r == e && (r = 1.70158),
              n * ((i = i / o - 1) * i * ((r + 1) * i + r) + 1) + s
            );
          },
          easeInOutBack: function (t, i, s, n, o, r) {
            return (
              r == e && (r = 1.70158),
              (i /= o / 2) < 1
                ? (n / 2) * i * i * ((1 + (r *= 1.525)) * i - r) + s
                : (n / 2) * ((i -= 2) * i * ((1 + (r *= 1.525)) * i + r) + 2) +
                  s
            );
          },
          ...
          easeInOutBounce: function (e, i, s, n, o) {
            return i < o / 2
              ? 0.5 * t.easing.easeInBounce(e, 2 * i, 0, n, o) + s
              : 0.5 * t.easing.easeOutBounce(e, 2 * i - o, 0, n, o) +
                  0.5 * n +
                  s;
          },
        });
  ...
  (function (t, e) {
    t.effects.blind = function (e) {
      return this.queue(function () {
        ...
        var r = t.effects.createWrapper(i).css({overflow: "hidden"}),
  ...
  (function (t, e) {
    t.effects.bounce = function (e) {
      return this.queue(function () {
        ...
        ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -r : r),
        "hide" == n && (r /= 2 * a),
        "hide" != n && a--,
        "show" == n) &&
          (((p = {opacity: 1})[h] = ("pos" == c ? "+=" : "-=") + r),
          i.animate(p, l / 2, e.options.easing),
          (r /= 2),
          a--);
        for (var u = 0; u < a; u++) {
          var d = {};
          ((f = {})[h] = ("pos" == c ? "-=" : "+=") + r),
            ...
            i
              ...
              .animate(d, l / 2, e.options.easing),
            (r = "hide" == n ? 2 * r : r / 2);
        }
        if ("hide" == n) {
          var p;
          ((p = {opacity: 0})[h] = ("pos" == c ? "-=" : "+=") + r),
          ...
          ((f = {})[h] = ("pos" == c ? "-=" : "+=") + r),
            ...
            i
              .animate(f, l / 2, e.options.easing)
              .animate(d, l / 2, e.options.easing, function () {
                t.effects.restore(i, s),
                  t.effects.removeWrapper(i),
                  e.callback && e.callback.apply(this, arguments);
              });
    ...
    t.effects.drop = function (e) {
      return this.queue(function () {
        ...
        var r = "up" == o || "down" == o ? "top" : "left",
          ...
          l =
            e.options.distance ||
            ("top" == r ? i.outerHeight(!0) / 2 : i.outerWidth(!0) / 2);
    ...
    t.effects.fold = function (e) {
      return this.queue(function () {
        ...
        var l = t.effects.createWrapper(i).css({overflow: "hidden"}),
          ...
          d = /([0-9]+)%/.exec(o);
        d && (o = (parseInt(d[1], 10) / 100) * u["hide" == n ? 0 : 1]),
          "show" == n &&
            l.css(r ? {height: 0, width: o} : {height: o, width: 0});
        var p = {},
          f = {};
        (p[c[0]] = "show" == n ? u[0] : o),
          (f[c[1]] = "show" == n ? u[1] : 0),
    ...
    t.effects.pulsate = function (e) {
      return this.queue(function () {
        var i = t(this),
          ...
          r = i.is(":visible"),
          a = 0;
        r || (i.css("opacity", 0).show(), (a = 1)),
          (("hide" == s && r) || ("show" == s && !r)) && n--;
        for (var l = 0; l < n; l++)
          i.animate({opacity: a}, o, e.options.easing), (a = (a + 1) % 2);
        i.animate({opacity: a}, o, e.options.easing, function () {
    ...
    (t.effects.puff = function (e) {
      return this.queue(function () {
        ...
        t.extend(e.options, {
          ...
          from: "hide" == s ? r : {height: r.height * o, width: r.width * o},
        }),
        ...
        return this.queue(function () {
          ...
          ("box" != u && "both" != u) ||
            ...
            ("content" == u || "both" == u) &&
              g.from.y != g.to.y &&
              ((s = s.concat(r)),
              (i.from = t.effects.setTransition(i, r, g.from.y, i.from)),
              (i.to = t.effects.setTransition(i, r, g.to.y, i.to))),
    ...
    t.effects.slide = function (e) {
      return this.queue(function () {
        ...
        var r = "up" == o || "down" == o ? "top" : "left",
          ...
          l =
            e.options.distance ||
            ("top" == r ? i.outerHeight(!0) : i.outerWidth(!0));
        ...
        if (!s.disabled)
          if (e.target) {
            var n = t(e.currentTarget || i),
              o = n[0] === this.active[0];
            if (
              ((s.active = (!s.collapsible || !o) && this.headers.index(n)),
              !(this.running || (!s.collapsible && o)))
            ) {
              var r = this.active,
                a =
                  ((c = n.next()),
                  ...
                  this.headers.index(this.active[0]) >
                    this.headers.index(n[0]));
              (this.active = o ? t([]) : n),
                this._toggle(c, l, h, o, a),
                r
                ...
                (s = l[0].style.width),
                  l.width(
                    l.parent().width() -
                      ...
                      (parseFloat(l.css("borderLeftWidth")) || 0) -
                      (parseFloat(l.css("borderRightWidth")) || 0),
                  ),
                  t.each(
                    ["height", "paddingTop", "paddingBottom"],
                    function (i, s) {
                      a[s] = "hide";
                      var n = ("" + t.css(e.toShow[0], s)).match(
                        /^([\d+-.]+)(.*)$/,
                      );
                      r[s] = {value: n[1], unit: n[2] || "px"};
                    },
                  ),
                      ...
                      step: function (t, i) {
                        "height" == i.prop &&
                          ...
                          (e.toShow[0].style[i.prop] =
                            o * r[i.prop].value + r[i.prop].unit);
                      },
                      duration: e.duration,
                      easing: e.easing,
                      complete: function () {
    ...
    t.widget("ui.button", {
      ...
      destroy: function () {
        this.element.removeClass("ui-helper-hidden-accessible"),
          this.buttonElement
            .removeClass(r + " ui-state-hover ui-state-active  " + a)
            .removeAttr("role")
          ...
          if (!1 !== s) {
            ...
            if (
              ...
              e.dpDiv.zIndex($(t).zIndex() + 1),
                ...
                $.effects && $.effects[r]
                  ? e.dpDiv.show(r, $.datepicker._get(e, "showOptions"), a, l)
                  : e.dpDiv[r || "show"](r ? a : null, l),
                (!r || !a) && l(),
                e.input.is(":visible") &&
                  !e.input.is(":disabled") &&
                  e.input.focus(),
            ...
            null == e || "" === e
              ...
              : "string" == typeof e
                      ...
                      switch (a[2] || "d") {
                        ...
                        case "M":
                          (n += parseInt(a[1], 10)),
                            (o = Math.min(
                              o,
                              $.datepicker._getDaysInMonth(s, n),
                            ));
                          break;
                        case "y":
                        case "Y":
                ...
                : "number" == typeof e
                  ? isNaN(e)
                    ? i
                    : ((s = e), (n = new Date()).setDate(n.getDate() + s), n)
                  : new Date(e.getTime());
        return (
      ...
      _generateHTML: function (t) {
        ...
        for (
          ...
          for (var H = 0; H < r[1]; H++) {
            ...
            this.maxRows = Q;
            for (
              var V = this._daylightSavingAdjust(new Date(f, p, 1 - U)), X = 0;
              X < Q;
              X++
            ) {
              R += "<tr>";
              ...
              for (B = 0; B < 7; B++) {
                ...
                (G +=
                  ...
                  ((V.getTime() == L.getTime() &&
                    p == t.selectedMonth &&
                    t._keyEvent) ||
                  (F.getTime() == V.getTime() && F.getTime() == L.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (tt
              ...
              s.bind("keydown.ui-dialog", function (e) {
                if (e.keyCode === t.ui.keyCode.TAB) {
                  var i = t(":tabbable", this),
                    s = i.filter(":first"),
                    n = i.filter(":last");
                  return e.target !== n[0] || e.shiftKey
                    ? e.target === s[0] && e.shiftKey
                      ? (n.focus(1), !1)
                      : void 0
                    : (s.focus(1), !1);
                }
      ...
      _setOption: function (e, s) {
        ...
        switch (e) {
          ...
          case "resizable":
            ...
            r && !s && n.resizable("destroy"),
              r && "string" == typeof s && n.resizable("option", "handles", s),
              !r && !1 !== s && this._makeResizable(s);
            break;
          case "title":
          ...
          top: function (e, i) {
            if (i.at[1] !== n) {
              var s = t(window),
                ...
                l = -2 * i.offset[1];
              e.top +=
                i.collisionPosition.top < 0 ? r + a + l : o > 0 ? r + a + l : 0;
            }
          },
        },
      }),
      t.offset.setOffset ||
        ((t.offset.setOffset = function (e, i) {
          ...
          var s = t(e),
            ...
            a = {top: i.top - n.top + o, left: i.left - n.left + r};
                ...
                !0 === l.options.range &&
                  ("horizontal" === l.orientation
                    ...
                    : (0 === s &&
                        l.range
                          .stop(1, 1)
                          [h ? "animate" : "css"]({bottom: e + "%"}, a.animate),
                      1 === s &&
                        l.range[h ? "animate" : "css"](
                          {height: e - i + "%"},
                          {queue: !1, duration: a.animate},
  ...
  (function (t, e) {
    ...
    t.widget("ui.tabs", {
      ...
      _tabify: function (e) {
        ...
        (this.list = this.element.find("ol,ul").eq(0)),
          ...
          e
            ? (this.element.addClass(
              ...
              void 0 === r.selected
                ? (location.hash &&
                  ...
                  "number" != typeof r.selected &&
                    r.cookie &&
                    (r.selected = parseInt(o._cookie(), 10)),
                  "number" != typeof r.selected &&
              ...
              (r.selected =
                (r.selected >= 0 && this.anchors[r.selected]) || r.selected < 0
                  ? r.selected
                  : 0),
              (r.disabled = t
                .unique(
                ...
                .sort()),
              -1 != t.inArray(r.selected, r.disabled) &&
                r.disabled.splice(t.inArray(r.selected, r.disabled), 1),
              this.panels.addClass("ui-tabs-hide"),
              this.lis.removeClass("ui-tabs-selected ui-state-active"),
              r.selected >= 0 &&
                this.anchors.length &&
                (o.element
                  .find(o._sanitizeSelector(o.anchors[r.selected].hash))
                ...
                o.element.queue("tabs", function () {
                  o._trigger(
                    ...
                    null,
                    o._ui(
                      o.anchors[r.selected],
                      o.element.find(
                        o._sanitizeSelector(o.anchors[r.selected].hash),
                      )[0],
                    ),
                  );
                }),
        ...
        for (var l, h = 0; (l = this.lis[h]); h++)
          t(l)[
            -1 == t.inArray(h, r.disabled) || t(l).hasClass("ui-tabs-selected")
              ? "removeClass"
              : "addClass"
          ]("ui-state-disabled");
        if (
        ...
        r.fx &&
          (t.isArray(r.fx) ? ((s = r.fx[0]), (n = r.fx[1])) : (s = n = r.fx));
        var d = n
            ? function (e, s) {
        ...
        this.anchors.bind(r.event + ".tabs", function () {
          ...
          if (
            ...
            return this.blur(), !1;
          if (
            ((r.selected = o.anchors.index(this)), o.abort(), r.collapsible)
          ) {
            if (i.hasClass("ui-tabs-selected"))
              return (
                (r.selected = -1),
                r.cookie && o._cookie(r.selected, r.cookie),
                o.element
                  .queue("tabs", function () {
                    p(e, s);
                  })
          ...
          if ((r.cookie && o._cookie(r.selected, r.cookie), !n.length))
      ...
      add: function (e, i, s) {
        ...
        var n = this,
          o = this.options,
          r = t(
            o.tabTemplate.replace(/#\{href\}/g, e).replace(/#\{label\}/g, i),
          ),
        ...
        return (
          l.length ||
            (l = t(o.panelTemplate).attr("id", a).data("destroy.tabs", !0)),
          l.addClass(
            "ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide",
          ),
          s >= this.lis.length
            ? (r.appendTo(this.list), l.appendTo(this.list[0].parentNode))
            : (r.insertBefore(this.lis[s]), l.insertBefore(this.panels[s])),
  ...
  (function (t, e) {
    ...
    t.each("branch form header step wrapper".split(" "), function () {
      ...
      t.widget("kf." + l, {
        ...
        options: {
          animations: {
            show: {options: {duration: 0}, properties: {opacity: "show"}},
            hide: {options: {duration: 0}, properties: {opacity: "hide"}},
          },
          backward: ".backward",
          branches: ".branch",
          disabled: !1,
        ...
        _create: function () {
          ...
          u[0].elements
            ? (e = u)
            : (e = u.find("form")).length || (e = u.closest("form")),
            (o = u.find(c.header)).length || (o = e.find(c.header)),
            (a.elements = {
            ...
            d.attr("id") || d.attr("id", l + "-" + ++i),
            a.elements.forward.click(function (t) {
              t.preventDefault(), a.forward(t);
            }),
            a.elements.backward.click(function (t) {
              t.preventDefault(), a.backward(t);
            }),
            (a._currentState = {branchesActivated: [], stepsActivated: []}),
            (a._stepCount = a.elements.steps.length),
            (a._lastStepIndex = a._stepCount - 1),
            (a._branchLabels = []),
            a.elements.steps.each(function (e) {
          ...
          t.isFunction(s) && ((n = s), (s = e)),
            (function e() {
              r._transition(a, function (h, c) {
                if (-1 === (a = r.stepIndex(h, c)))
                  throw new Error('[_fastForward]: Invalid step "' + h + '"');
                if (t.inArray(a, l) >= 0)
                  throw new Error(
                    '[_fastForward]: Recursion detected on step "' + h + '"',
                  );
                l.push(a),
                  a === r._lastStepIndex || (s ? ++o : a) === i
                    ? n.call(r, a, l)
                    : e();
              });
            })();
        ...
        _state: function (e, i) {
          ...
          for (var o, a, l, h = 0, c = i.length; h < c; h++)
            (e = i[h]),
              (o = this._branchLabels[e]),
              !n.stepIndex || n.stepIndex < e
                ? t.inArray(e, n.stepsActivated) < 0 &&
                  (n.stepsActivated.push(e),
                  t.inArray(o, n.branchesActivated) < 0 &&
                    n.branchesActivated.push(o))
                : n.stepIndex > e &&
                  ((a = t.inArray(o, n.branchesActivated) + 1),
        ...
        _update: function (e, i) {
          ...
          (this._currentState = i),
            ...
            i.step.hasClass(n.stepClasses.unidirectional)
              ? this.elements.backward.attr(a, !0)
              : this.elements.backward.removeAttr(a),
            (i.isLastStepInBranch && !i.step.attr(n.stateAttribute)) ||
            i.step.hasClass(n.stepClasses.stop)
              ? this.elements.forward.attr(a, !0)
              : this.elements.forward.removeAttr(a),
            n.enableSubmit || i.step.hasClass(n.stepClasses.submit)
              ? this.elements.submit.removeAttr(a)
              : this.elements.submit.attr(a, !0),
            s.step &&
              (this._trigger("afterSelect", e, i),
              this._trigger(
                i.isMovingForward ? "afterForward" : "afterBackward",
                e,
                i,
              ));
        },
        ...
        select: function (i, s, n, o, r) {
          i instanceof t.Event || ((r = o), (o = n), (n = s), (s = i), (i = e)),
            s !== e &&
              (t.isArray(s)
                ? ((r = o), (o = n), (n = s[1]), (s = s[0]))
                : typeof n === u
                  ? ((r = o), (o = n), (n = e))
                  : t.isArray(n) && ((r = n), (n = e)),
              this._move(s, n, o, r, function (t, e) {
      ...
      t.extend(t.validator, {
        ...
        prototype: {
          ...
          check: function (e) {
            ...
            for (var r in s) {
              var a = {method: r, parameters: s[r]};
              try {
                if (
                  "dependency-mismatch" ===
                  (i = t.validator.methods[r].call(this, o, e, a.parameters))
                ) {
                  n = !0;
                  continue;
                }
        ...
        attributeRules: function (e) {
          ...
          for (var o in t.validator.methods) {
            var r;
            "required" === o
              ? ("" === (r = s.get(0).getAttribute(o)) && (r = !0), (r = !!r))
              : (r = s.attr(o)),
              /min|max/.test(o) &&
                (null === n || /number|range|text/.test(n)) &&
                (r = Number(r)),
              r ? (i[o] = r) : n === o && "range" !== n && (i[o] = !0);
          }
          return (
            i.maxlength &&
        ...
        dataRules: function (e) {
          ...
          for (i in t.validator.methods)
            void 0 !== (s = o.data("rule-" + i.toLowerCase())) && (n[i] = s);
          return n;
        },
  ...
  (function (t) {
    ...
    function y(t, e, i) {
      ...
      else if (i == c) for (var p in d) d[p] ? w(t, p, !0) : C(t, p, !0);
      else
        (e && "toggle" != i) ||
          (e || t[m]("ifClicked"), d ? s[u] !== n && C(t, r) : w(t, r));
    }
    function w(s, c, d) {
      var p = s[0],
        m = s.parent(),
      ...
      if (!0 !== p[c]) {
        ...
        b
          ? ((p[c] = !0), p[o] && C(s, o, "force"))
          : (d || (p[c] = !0), v && p[h] && C(s, h, !1)),
          I(s, v, c, d);
      }
      p[a] && k(s, _, !0) && m.find("." + i).css(_, "default"),
        m[f](E || k(s, c) || ""),
        m.attr("role") && !b && m.attr("aria-" + (y ? a : o), "true"),
        m[g](x || k(s, w) || "");
    }
    function C(t, e, s) {
      var n = t[0],
        ...
        b = k(t, v + D(n[u])),
        y = k(t, e + D(n[u]));
      !1 !== n[e] && ((!p && s && "force" != s) || (n[e] = !1), I(t, d, v, s)),
        !n[a] && k(t, _, !0) && c.find("." + i).css(_, "pointer"),
        c[g](y || k(t, e) || ""),
        c.attr("role") && !p && c.attr("aria-" + (m ? a : o), "false"),
        c[f](b || k(t, v) || "");
    }
    function x(i, s) {
      i.data(e) &&
        (i.parent().html(i.attr("style", i.data(e).s || "")),
        s && i[m](s),
        i.off(".i").unwrap(),
        t(v + '[for="' + i[0].id + '"]')
          .add(i.closest(v))
    ...
    t.fn[e] = function (r, l) {
      ...
      if (
        ...
        return (
          ...
          k.each(function () {
            var e = t(this);
            "destroy" == r ? x(e, "ifDestroyed") : y(e, !0, r),
              t.isFunction(l) && l();
          })
        );
      ...
      return (
        ...
        k.each(function () {
          ...
          var l,
            ...
            z =
              h[u] == s ? I.checkboxClass || "i" + s : I.radioClass || "i" + n,
          ...
          H &&
            ...
            (l = t('<ins class="' + i + '"/>')
              .css(E)
              .appendTo(L)),
            r.data(e, {o: I, s: r.attr("style")}).css(O),
            I.inheritClass && L[f](h.className || ""),
            I.inheritID && _ && L.attr("id", e + "-" + _),
            "static" == L.css("position") && L.css("position", "relative"),
            y(r, !0, c),
            N.length &&
              N.on(d + ".i mouseover.i mouseout.i " + p, function (e) {
                var i = e[u],
                  s = t(this);
                if (!h[a]) {
                  if (i == d) {
            ...
            r.on(
              d + ".i focus.i blur.i keyup.i keydown.i keypress.i",
              function (t) {
                var e = t[u],
                  i = t.keyCode;
                return (
                  e != d &&
                  ("keydown" == e && 32 == i
                    ? ((h[u] == n && h[o]) || (h[o] ? C(r, o) : w(r, o)), !1)
                    : void ("keyup" == e && h[u] == n
                        ? !h[o] && w(r, o)
                        : /us|ur/.test(e) && L["blur" == e ? g : f](S)))
                );
              },
            ),
            l.on(
              d + " mousedown mouseup mouseover mouseout " + p,
              function (t) {
                var e = t[u],
                  i = /wn|up/.test(e) ? A : T;
                if (!h[a]) {
                  if (
                    (e == d
                      ? y(r, !1, !0)
                      : (/wn|er|in/.test(e) ? L[f](i) : L[g](i + " " + A),
                        N.length &&
                          P &&
                          i == T &&
                          N[/ut|nd/.test(e) ? g : f](M)),
                    !b)
                  )
                    return !1;
                  t.stopPropagation();
